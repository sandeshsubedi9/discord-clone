                ...
                <div className='flex flex-col w-full'>
                    <div className='flex items-center gap-x-2'>
                        <div className='flex items-center'>
                            <p onClick={onMemberClick} className='text-sm font-semibold hover:underline mr-2 cursor-pointer'>
                                {member.profile.name}
                            </p>
                    ...
                    {!fileUrl && !isEditing && (
                        <p className={cn('text-sm text-zinc-600 dark:text-zinc-300',
                            ...
                            {content}
                            {isUpdated && !deleted && (
                                <span className='text-zinc-500 dark:text-zinc-400 text-[10px] mx-2'>(edited)</span>
                            )}
                        </p>
                    )}
                    {!fileUrl && isEditing && (
